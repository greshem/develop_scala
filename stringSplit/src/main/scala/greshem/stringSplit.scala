...
object stringSplit 
{
  ...
  {
    var filter_string="sys=city,cmdtype=,commandid=11,houseId=237,starttime=1459930200,endtime=1459930400,srcip=,srcport=,destip=,destport=,domainname=";

    val params: Array[String] = filter_string.split(",")
